...
function checkWorkerBehavior() {
  const script = [
    ...
    "}",
    "for (const [clean, html] of [['/generator', '/generator.html'], ['/generator/', '/generator.html'], ['/blog/email-signature-best-practices', '/blog/email-signature-best-practices.html'], ['/blog/email-signature-best-practices/', '/blog/email-signature-best-practices.html'], ['/seo/email-signature-checker', '/seo/email-signature-checker.html'], ['/seo/email-signature-checker/', '/seo/email-signature-checker.html']]) {",
    ...
    "const blockedPaths = ['/AGENTS.md', '/.gitignore', '/package.json', '/package.json/', '/package-lock.json', '/_worker.js', '/_worker.js/', '/wrangler.toml', '/_headers', '/_redirects', '/NEXT_STEPS.md', '/test.html', '/generate-pages.js', '/update-sitemap.js', '/automation/', '/automation/send-email.js', '/automation/send-email.js/', '/scripts/', '/scripts/validate-site.js', '/templates/private.html', '/datasets/industries.json', '/assets/icon-masks/linkedin.bin', '/js/png-encoder.js', '/js/icon-masks.js', '/.git/config', '/.claude/launch.json', '/.agent/artifacts/review/manifest.json', '/.wrangler/state.json'];",
